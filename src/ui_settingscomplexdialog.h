...
public:
    ...
    {
        SettingsComplexDialog->setWindowTitle(QApplication::translate("SettingsComplexDialog", "Dialog", 0));
        pushButton->setText(QApplication::translate("SettingsComplexDialog", "Save", 0));
        label_axis->setText(QApplication::translate("SettingsComplexDialog", "Surface:", 0));
        label_surfaceColor_Pi_2->setText(QString());
        pushButton_surfaceColor_Pi_2->setText(QApplication::translate("SettingsComplexDialog", "pi/2", 0));
        label_surfaceColor_3_pi_2->setText(QString());
        pushButton_surfaceColor_3_Pi_2->setText(QApplication::translate("SettingsComplexDialog", "3pi/2", 0));
        checkBox_surfaceEnabled->setText(QString());
        pushButton_surfaceColor_0->setText(QApplication::translate("SettingsComplexDialog", "0", 0));
        label_surfaceColor_0->setText(QString());
        pushButton_surfaceColor_Pi->setText(QApplication::translate("SettingsComplexDialog", "pi", 0));
        label_surfaceColor_pi->setText(QString());
        label_5->setText(QApplication::translate("SettingsComplexDialog", "Range:", 0));
        label_6->setText(QApplication::translate("SettingsComplexDialog", "Re:", 0));
        label_7->setText(QApplication::translate("SettingsComplexDialog", "Im:", 0));
        label_8->setText(QApplication::translate("SettingsComplexDialog", "F:", 0));
        label->setText(QApplication::translate("SettingsComplexDialog", "Center:", 0));
        label_2->setText(QApplication::translate("SettingsComplexDialog", "Re:", 0));
        label_3->setText(QApplication::translate("SettingsComplexDialog", "Im:", 0));
        label_4->setText(QApplication::translate("SettingsComplexDialog", "F:", 0));
        label_12->setText(QApplication::translate("SettingsComplexDialog", "Variable:", 0));
        lineEdit_varName->setText(QApplication::translate("SettingsComplexDialog", "z", 0));
        label_9->setText(QApplication::translate("SettingsComplexDialog", "Net periodicity:", 0));
        label_10->setText(QApplication::translate("SettingsComplexDialog", "Re:", 0));
        label_11->setText(QApplication::translate("SettingsComplexDialog", "Im:", 0));
        comboBox_netRePeriodicy->clear();
        comboBox_netRePeriodicy->insertItems(0, QStringList()
         << QApplication::translate("SettingsComplexDialog", "Very low", 0)
         << QApplication::translate("SettingsComplexDialog", "Low", 0)
         << QApplication::translate("SettingsComplexDialog", "Decreased", 0)
         << QApplication::translate("SettingsComplexDialog", "Middle", 0)
         << QApplication::translate("SettingsComplexDialog", "Increased", 0)
         << QApplication::translate("SettingsComplexDialog", "High", 0)
         << QApplication::translate("SettingsComplexDialog", "Very high", 0)
         << QApplication::translate("SettingsComplexDialog", "Ultra high", 0)
        );
